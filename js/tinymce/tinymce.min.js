...
!(function () {
        ...
        loadAll: (e) =>
          Promise.allSettled(q(e, (e) => a(e).then(N(e)))).then((e) => {
            ...
            return t.fail.length > 0
              ? Promise.reject(q(t.fail, (e) => e.reason))
              : q(t.pass, (e) => e.value);
          }),
        unload: i,
        unloadAll: (e) => {
      ...
      Li.isTextPosition(t)
        ...
        : ((e, t) =>
            t.container() === e.parentNode
              ...
              : gc(e, t))(e, t),
    hc = (e) => {
      dc(e) && $r(e) && (qr(e) ? e.removeAttribute("data-mce-caret") : uc(e)),
      ...
      ((e, t, n = !1) =>
        2 === t
          ...
          ? ((e) => {
              const t = e.getRng();
              return {
                start: Vi(e.dom.getRoot(), Li.fromRangeStart(t)),
                end: Vi(e.dom.getRoot(), Li.fromRangeEnd(t)),
                forward: e.isForward(),
              };
            })(e)
          : t
  ...
  const Ff = (e) => "textarea" === Ht(e),
    ...
    Wf = (e, t, n, o, r, s) => {
      ...
      i < n
        ? Vf(e, r, o, !1 !== s, t)
        : i > a
        ? Vf(e, r, o, d ? !1 !== s : !0 === s, t)
        : l > a && !d && Vf(e, r, o, !0 === s, t);
    },
    Kf = (e, t, n, o, r) => {
  ...
  const gg = Oa.DOM,
      ...
      e.inline
        ? ((e) => {
            ...
            return (
              ...
              tg(n) ||
                ((o = n),
                ng(qn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
            );
            var n, o;
          })(e)
    ...
    Og = (e) => {
      ...
      return (
        t ||
        H(Ag, Ht(e)) ||
        ((e) => Vt(e) && "false" === en(e, "contenteditable"))(e)
      );
    },
          ...
          ? ((n = $g(e)),
            ((e) => {
              ...
              for (; null !== n; ) {
                ...
                (n = t.nextNode()),
                  m(e.nodeValue) && e.nodeValue.includes(Mr) && wo(yn(e));
              }
            })(n),
            jg(n, t) && Hg(n, t))
          : jg(e, t) && ((n = $g(e)), Hg(n, t)),
  ...
  const Jg = ["font", "text-decoration", "text-emphasis"],
    ...
    qp = (e, t, n) => {
      const o = t.data,
        r = Li(t, 0);
      return n || !Hp(o, 0) || jp(e, r)
        ? !!(n && $p(o, 0) && Up(e, r)) && ((t.data = pr + o.slice(1)), !0)
        : ((t.data = " " + o.slice(1)), !0);
    },
    Vp = (e, t, n) => {
      const o = t.data,
        r = Li(t, o.length - 1);
      return n || !Hp(o, o.length - 1) || jp(e, r)
        ? !!(n && $p(o, o.length - 1) && zp(e, r)) &&
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome()
            ...
            () => (
              n &&
                (o.each((e) => Yp(e.dom, e.dom.length)),
                r.each((e) => Gp(e.dom, 0))),
              t
            )
          )
    ...
    _h = (e) => (t) =>
      Sh(t, e).map((e) =>
        ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, Ch(e))
      ),
    Nh = (e, t, n, o) => {
        ...
        const e = kh(n.startContainer, o),
          ...
          r = e
            .bind(
              (
                (e) => (t) =>
                  Xu(t, e).bind((e) => de(Ch(e)).map((e) => wh(t, e)))
              )(o)
            )
            .bind(_h(o)),
          s = t
            .bind(
              (
                (e) => (t) =>
                  Xu(t, e).bind((e) => le(Ch(e)).map((e) => wh(e, t)))
              )(o)
            )
            .bind(_h(o));
    ...
    Rh = (e, t) => Z(e, (e) => En(e, t)),
    Ah = (e) =>
      Mt(Rh(e.cells, e.rng.start), Rh(e.cells, e.rng.end), (t, n) =>
        e.cells.slice(t, n + 1)
      ),
    Oh = (e, t) => {
            ...
            Nh(e, t, n, o)
              ...
              .bind((e) => {
                ...
                if (o && e.cells.length === r.length)
                  return I.some(xh.fullTable(e.table));
                if (r.length > 0) {
          ...
          ((e, t, n, o) => {
            ...
            It(
              ((e, t) => {
                ...
                return (
                  Hh(t, n) || fu(t, e.getBody(), n).exists((e) => Hh(t, e))
                );
              })(e, t),
              E
            )
              ...
              : ((e, t, n, o) =>
                  zh(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        Th(t, n).bind((t) =>
                          t.fold(O(Ih, e), O(Fh, e), O(Lh, e), O(Mh, e))
                        ))(e, t, n),
                    (t) => ((e, t) => jh(e, t))(e, t)
                  ))(e, o, r, t);
          })(e, n, o);
        ...
        if (c && f.length > 1)
          if (t.isValidChild(c.name, i.name)) {
            ...
            eb(t, s, a, u)
              ...
              (c = f[0]),
              (eb(t, s, a, c) || Zh(c, "br")) && c.empty().remove();
          } else nb(i, t);
        else if (i.parent) {
          if ("li" === i.name) {
            let e = i.prev;
    ...
    fb = (e, t, n) => {
      ...
      m === f &&
        ...
        s.isCollapsed() ||
          ((e) => {
            ...
            ((e, t, n) =>
              !!C(n) && n === e.getParent(t.endContainer, mb) && Zu(yn(n), t))(
              t,
              n,
              o
            )
      ...
      const g = s.getNode(),
        ...
        h = i.parse(t, p);
      if (!0 === n.paste && ab(e.schema, h) && ((e, t) => !!lb(e, t))(a, g))
        return (u = cb(d, a, s.getRng(), h)), u && s.setRng(u), t;
      !0 === n.paste &&
        ((e, t, n, o) => {
          var r;
      ...
      if ((e._selectionOverrides.showBlockCaretContainer(g), p.invalid)) {
        ...
        ob(b, e.schema, f),
          Qh(i.getNodeFilters(), i.getAttributeFilters(), u),
          (t = d.serialize(u)),
          ...
          if (t) {
            ...
            Dt.each(o.select("*[data-mce-fragment]"), (e) => {
              if (
                ...
                ((e, t) => ne(Zg(e, t), (e) => !((e) => Qg.has(e))(e)))(o, e)
              )
                for (
    ...
    wb = (e, t, n, o, r) => {
      ...
      const a = e.dom.getParent(
        t,
        (t) => !!Cb(e, t, n) || t.parentNode === s || !!Eb(e, t, n, o, !0)
      );
      return !!Eb(e, a, n, o, r);
    },
    xb = (e, t, n) =>
  ...
  const jb = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
      ...
      return p(n)
        ? J(
            ...
            (e) =>
              km(e) &&
              "span" === e.inline &&
              ((e) => f(e.styles) && $(me(e.styles), (e) => H(jb, e)))(e)
          )
        : I.none();
    },
        ...
        ((n.list_block && rv(t, n.list_block)) ||
          V(ce(t.childNodes), (t) => {
            um(e, a, t.nodeName.toLowerCase())
              ? r
                ? r.appendChild(t)
                : ((r = lv(s, t, a)), s.setAttribs(r, Rl(e)))
              : (r = null);
          })),
    ...
    fv = (e, t, n, o, r) => {
      ...
      ov(n.styles, (a, i) => {
        const { name: l, value: d } = uv(i, a, o),
          c = hm(d, l);
        (n.remove_similar || h(d) || !$o(r) || rv(bm(e, r, l), c)) &&
          e.setStyle(t, l, ""),
          (s = !0);
      }),
        s && mv(e, t);
    ...
    gv = (e, t, n, o, r) => {
      ...
      if (
        ...
        return cv(e, o, t), tv.removed();
      if (!t.ceFalseOverride && o && "false" === s.getContentEditableParent(o))
        return tv.keep();
      if (o && !xb(s, o, t) && !((e, t) => t.links && "A" === e.nodeName)(o, t))
        return tv.keep();
      const l = o,
        ...
        fv(s, l, t, n, r),
          ov(t.attributes, (e, o) => {
            ...
            if (
              ...
              if (
                (nv.test(a) && l.removeAttribute("data-mce-" + a),
                "style" === a &&
                  Vo(["li"])(l) &&
        ...
        ((e, t, n, o, r) => {
          const s = e.formatter.get(t),
              ...
              return ((e, t, n, o, r, s, a, i) => {
                ...
                if (n) {
                  ...
                  for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                    ...
                    for (
                      let n = 0;
                      n < t.length && ((o = pv(e, t[n], i, o)), null !== o);
                      n++
                    );
            ...
            f = (t) => {
              ...
              if (a.split) {
                if (
                  ((r = Bf(r)), (n = av(e, r, !0)), (o = av(e, r)), n !== o)
                ) {
    ...
    bv = (e, t, n, o, r) =>
      gv(e, t, n, o, r).fold(L, (t) => (e.dom.rename(o, t), !0), M),
    vv = Dt.each,
    yv = Dt.each,
    Cv = (e, t, n, o) => {
      if (
        ...
        f = (o, a, i) => {
          ...
          zm(o, a, (a) => {
            ...
            const p = (a) => {
              ...
              if (
                ((o) =>
                  ((e) => wm(e) && !0 === e.wrapper)(s) && Eb(e, o, t, n))(a)
              )
                u = null;
              else {
                if (
              ...
              (!(l.length > 1) && o.isBlock(a)) || 0 !== i
                ? (km(s) || (wm(s) && s.wrapper)) &&
                  (s.exact ||
                    ...
                    (a = ((e) => {
                      const t = J(e.childNodes, sm).filter(
                        (e) =>
                          "false" !== o.getContentEditable(e) && xb(o, e, s)
                      );
                      return t
                        .map((t) => {
                          const n = o.clone(t, !1);
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    (Eb(e, s, n, o) && bv(e, t, o, r)) ||
                      (t.merge_with_parents &&
                        s &&
                        e.dom.getParent(
                          s,
                          (s) => !!Eb(e, s, n, o) && (bv(e, t, o, r), !0)
                        ));
                  })(e, s, t, n, a),
                  ((e, t, n, o) => {
  ...
  var by = Xv([
    ...
    Iy = (function e() {
      var t =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : My(),
        n = function (t) {
          return e(t);
        };
      if (
      ...
      var w = (function (e, t) {
          if ("object" !== zv(e) || "function" != typeof e.createPolicy)
            return null;
          var n = null,
      ...
      var T,
        ...
        xe = function (e) {
          (ye && ye === e) ||
            ...
            (ue =
              "ADD_URI_SAFE_ATTR" in e ? gy(py(me), e.ADD_URI_SAFE_ATTR) : me),
            (de =
              "ADD_DATA_URI_TAGS" in e ? gy(py(ce), e.ADD_DATA_URI_TAGS) : ce),
            ...
            e.FORBID_CONTENTS &&
              (ie === le && (ie = py(ie)), gy(ie, e.FORBID_CONTENTS)),
            re && (z["#text"] = !0),
        ...
        Pe = function (e) {
          ...
          if (
            ...
            e.hasChildNodes() &&
              ...
              uy(/<[/\w]/g, e.innerHTML) &&
              uy(/<[/\w]/g, e.textContent))
          )
            return Re(e), !0;
          if ("select" === r && uy(/<template/i, e.innerHTML)) return Re(e), !0;
          if (!z[r] || V[r]) {
            if (!V[r] && Me(r)) {
              if (q.tagNameCheck instanceof RegExp && uy(q.tagNameCheck, r))
                return !1;
              if (q.tagNameCheck instanceof Function && q.tagNameCheck(r))
                return !1;
            }
            if (re && !ie[r]) {
          ...
          return e instanceof l &&
            ...
            : ("noscript" !== r && "noembed" !== r) ||
              !uy(/<\/no(script|embed)/i, e.innerHTML)
            ? (X &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = ly(t, D, " ")),
                (t = ly(t, P, " ")),
                e.textContent !== t &&
                  (sy(n.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
              ...
              !(
                (Me(e) &&
                  ...
                  ((q.attributeNameCheck instanceof RegExp &&
                    uy(q.attributeNameCheck, t)) ||
                    (q.attributeNameCheck instanceof Function &&
                      q.attributeNameCheck(t)))) ||
                ("is" === t &&
                  q.allowCustomizedBuiltInElements &&
                  ((q.tagNameCheck instanceof RegExp &&
                    uy(q.tagNameCheck, n)) ||
                    (q.tagNameCheck instanceof Function && q.tagNameCheck(n))))
              )
            )
              return !1;
          } else if (ue[t]);
        ...
        (n.sanitize = function (e, r) {
          ...
          if (
            ...
            if ("function" != typeof e.toString)
              throw my("toString is not a function");
            if ("string" != typeof (e = e.toString()))
              throw my("dirty is not a string, aborting");
          }
          if (!n.isSupported) {
            if (
              "object" === zv(t.toStaticHTML) ||
          ...
          return (
            Q &&
              ...
              uy(Ly, a.ownerDocument.doctype.name) &&
  ...
  const Gy = (e, t, n, o) => {
    ...
    Xy = (e, t) =>
      e.hasAttribute(Wy) && ("id" === t || "class" === t || "style" === t),
    ...
    Jy = (e, t, n) => {
      ...
      for (let r = o.length - 1; r >= 0; r--) {
        const s = o[r],
          a = s.name,
          i = s.value;
        Yy(t, n, e.tagName.toLowerCase(), a, i) || Xy(e, a)
          ? Qy(a, n) && e.setAttribute(a, a)
          : e.removeAttribute(a);
      }
    },
    Zy = (e, t) => {
          ...
          (o.keepAttr = Yy(e, t, r, s, a)),
            o.keepAttr
              ? ((o.allowedAttributes[s] = !0),
                Qy(s, t) && (o.attrValue = s),
                e.allow_svg_data_urls &&
                  He(a, "data:image/svg+xml") &&
                  (o.forceKeepAttr = !0))
              : Xy(n, s) && (o.forceKeepAttr = !0);
        }),
        n
      );
    },
          ...
          parse: (e, n = {}) => {
            ...
            const [f, p] = ((e, t, n, o) => {
                const r = n.validate,
                  ...
                  a = t.getWhitespaceElements(),
                  i = tC(
                    eC("script,style,head,html,body,title,meta,param"),
                    t.getBlockElements()
                  ),
                  l = la(t),
                  d = /[ \t\r\n]+/g,
    ...
    pC = (e, t) => {
      ...
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++)
          if (En(o[n], t)) return I.some(uC(n, e));
      }
      return I.none();
    },
    hC = (e, t, n, o, r) => {
    ...
    NC = (e) => {
      ...
      return ((e) => null !== e.querySelector("iframe"))(n)
        ? {
            type: "fragmented",
            fragments: G(q(ce(n.childNodes), S(Fr, EC)), (e) => e.length > 0),
            content: "",
            bookmark: null,
            beforeBookmark: null,
          }
      ...
      undoManager: {
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return (
              t.typing && (t.add(), (t.typing = !1), DC(t, !1, n)),
              o.get() > 0 &&
                (o.set(o.get() - 1),
                (r = t.data[o.get()]),
                RC(e, r, !0),
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !TC(NC(e), t.data[0])))(
            e,
            t,
            n
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (PC(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n
          ),
      ...
      formatter: {
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                vb(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (Eb(e, t.dom, n) ? I.some(n) : I.none()))(n, t)
                    ),
                  n
                )
              )
        ...
        toggle: (t, n, o) =>
          ((e, t, n, o) => {
            const r = e.formatter.get(t);
            r &&
              (!Sb(e, t, n, o) || ("toggle" in r[0] && !r[0].toggle)
                ? xv(e, t, n, o)
                : hv(e, t, n, o));
          })(e, t, n, o),
        ...
        setContent: (t, n) =>
          ((e, t, n) =>
            I.from(e.getBody())
                      ...
                      if (0 === n.length || /^\s+$/.test(n)) {
                        ...
                        return (
                          e.schema.isValidChild(
                            ...
                            : n || (n = r),
                          pb(e, n, o.no_selection),
                          { content: n, html: n }
                        );
                      }
                      {
                        "raw" !== o.format &&
                          (n = Xg({ validate: !1 }, e.schema).serialize(
              ...
              .getOr({ content: t, html: gb(n.content) ? "" : n.content }))(
            e,
            t,
            n
          ),
                  ...
                  return ((e) =>
                    I.from(e.selection.getRng())
                      .map((t) => {
                        ...
                        if (
                          (e.dom.remove(i), xC(d, 0) || xC(d, d.length - 1))
                        ) {
                          const e = o.getOr(r),
                            t = kC(e),
                            n = t.indexOf(l);
        ...
        (e) => (
          ...
          t.filter(Kt).map((t) =>
            ((e, t, n, o) => {
              ...
              o
                ? (Xp(r, s, !1, !o), n.setStart(s, a))
                : (Xp(s, r, !1, !o), n.setEnd(s, a));
            })(e, t, n, o)
          )
        )
      ).orThunk(() => {
        ...
        return e.map((e) =>
          ((e, t) => {
            An(e).each((n) => {
              ...
              t && Up(n, Li(o, 0))
                ? Gp(o, 0)
                : !t && zp(n, Li(o, o.length)) && Yp(o, o.length);
            });
          })(e, o)
        );
      });
  ...
  const $C = (e) => !(!e || !e.ownerDocument) && Sn(yn(e.ownerDocument), yn(e)),
    qC = (e, t, n, o) => {
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        u = (e, t) => {
          if (!((e) => !!e && $C(e.startContainer) && $C(e.endContainer))(e))
            return;
          const n = d();
          if (
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => FC(e).selection.getContent(t, n))(
                e,
    ...
    GC = (e, t, n = {}) => {
      ...
      return iC(e, o)
        .map((t) => {
          const n = ((e, t, n) => IC(e).editor.setContent(t, n))(
            e,
            t.content,
            t
          );
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        He(o, "blob:")
                          ...
                          Pv(t).then((o) =>
                            Mv(o, !1, (n) => I.some(Iv(e, t, n))).getOrThunk(n)
                          )
                        );
                  }
                  var o, r;
  ...
  const Aw = (e, t) => {
      ...
      const r = Nw(),
        ...
        d = (t, n) => {
          V(e.undoManager.data, (e) => {
            "fragmented" === e.type
              ? (e.fragments = q(e.fragments, (e) => l(e, t, n)))
    ...
    zw = (e, t) => {
      const n = (t && t.schema) || ca({}),
        o = (e) => {
          ...
          return (
            ((e, t) => {
              t.classes.length > 0 && Fw.addClass(e, t.classes.join(" ")),
                Fw.setAttribs(e, t.attrs);
            })(n, t),
            n
          );
        },
    ...
    Hw = (e, t) => {
      ...
      var d;
      l.length > 0
        ? (l[0].name || (l[0].name = i), (i = t.selector), (a = zw(l, e)))
        : (a = zw([i], e));
    ...
    $w = (e) => {
      ...
      return (
          ...
          e.on("mouseup keydown", (t) => {
            ...
            ((e, t, n) => {
              ...
              Tb(e, null, n),
                (8 !== t && 46 !== t) ||
                  !o.isCollapsed() ||
                  o.getStart().innerHTML !== _b ||
                  Tb(e, ku(r, o.getStart())),
                (37 !== t && 39 !== t) || Tb(e, ku(r, o.getStart()));
            })(
              e,
              t.keyCode,
          ...
          })(n, e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => FC(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          matchAll: (t, n) =>
            ((e, t, n) => FC(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => FC(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              FC(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: O(Hw, e),
        }
      );
    },
    ...
    Vw = (e) => {
      const t = za(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => FC(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => FC(e).undoManager.undo(t, n, o))(e, r, n, o),
          ...
          hasUndo: () =>
            ((e, t, n) => FC(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => FC(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => FC(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
            ...
            e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                if (
                  ...
                  return (
                    t.beforeChange(), DC(t, !0, n), t.add({}, e), void o.set(!0)
                  );
    ...
    lx = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => ix(e, t.startContainer) || ix(e, t.endContainer))(e, t) &&
          n &&
          o
        );
        ...
        : ((e, t) => {
            const n = t.getRng();
            return Mt(
              ph(e, yn(n.startContainer)),
              ph(e, yn(n.endContainer)),
              (o, r) =>
                En(o, r)
                  ? I.none()
                  : I.some(() => {
    ...
    vx = (e) => {
      ...
      return (
        !t.collapsed &&
        (bx(e, !0).exists((e) => e.isEqual(Li.fromRangeStart(t))) ||
          bx(e, !1).exists((e) => e.isEqual(Li.fromRangeEnd(t))))
      );
    },
    yx = al([
      { remove: ["element"] },
          ...
          () =>
            ((e, t, n) => {
              ...
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (
                    e._selectionOverrides.hideFakeCaret(), rh(e, t, yn(n)), !0
                  ))(e, t),
                  ((e, t) => (n) => {
                  ...
                  .fold(
                    () =>
                      I.some(() => {
                        var n;
                        (n = yn(e.getBody())),
                          V(Fo(n, ".mce-offscreen-selection"), wo),
                          rh(e, t, yn(e.selection.getNode())),
                          hh(e);
                      }),
                    () => I.some(E)
                  )
    ...
    Ox = (e, t) =>
      e
        ? ((e) => {
            var t;
            if (_x(e.previousSibling))
              return (
                Rx(e.previousSibling) || e.previousSibling.appendData(Mr),
                e.previousSibling
              );
        ...
        : ((e) => {
            ...
            if (_x(e.nextSibling))
              return (
                Nx(e.nextSibling) || e.nextSibling.insertData(0, Mr),
                e.nextSibling
              );
    ...
    Bx = O(Ox, !1),
    Dx = (e, t) =>
      Jo(e.container()) ? Ox(t, e.container()) : Ox(t, e.getNode()),
    Px = (e, t) => {
      const n = t.get();
    ...
    Hx = (e, t, n) => {
      const o = uh(n);
      return jx(e, t, o).bind((e) =>
        vu(e, o).isNone() ? I.some(Ix.start(e)) : I.none()
      );
    },
    $x = (e, t, n) => {
      const o = ch(n);
      return jx(e, t, o).bind((e) =>
        bu(e, o).isNone() ? I.some(Ix.end(e)) : I.none()
      );
    },
    qx = (e, t, n) => {
      const o = uh(n),
    ...
    Zx = (e, t) =>
      e
        ? t.fold(S(I.some, Ix.start), I.none, S(I.some, Ix.after), I.none)
        : t.fold(I.none, S(I.some, Ix.before), I.none, S(I.some, Ix.end)),
    ek = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
      ...
      for (; s; ) {
        ...
        if (rr(n.getNode(!1)))
          return t === Jc.Forwards
            ? {
                positions: nk(t, a).concat([n]),
                breakType: tk.Br,
                breakAt: I.some(n),
              }
            : { positions: nk(t, a), breakType: tk.Br, breakAt: I.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = rk(0, t, s, n);
  ...
  const Ek = (e, t, n, o, r, s) => {
    ...
    Kk = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          fh(e),
          Wx(s, r, Li.fromRangeStart(e.selection.getRng()))
            .map(Xx)
            .bind(Wk(e, t))
            .each(P);
      }),
      ...
      if (e.selection.isCollapsed() && dd(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n
                ? e.fold(N(I.some(Xx(e))), I.none, N(I.some(Yx(e))), I.none)
                : e.fold(I.none, N(I.some(Yx(e))), I.none, N(I.some(Xx(e))))
            )
            .map(Wk(e, t))
            .getOrThunk(() => {
              const i = gu(n, r, o),
    ...
    sE = (e) => (
      ((e) => {
        ...
        return (
          t.collapsed &&
          (tE(t) || e.dom.isEmpty(t.startContainer)) &&
          !((e) => rE(yn(e.selection.getStart())))(e)
        );
      })(e) && eE(e, []),
      !0
    ),
    ...
    hE = (e, t, n) =>
      ue([pE, Ex, hx, (e, n) => Gk(e, t, n), ax, qh, Sx, iE, dx, oE], (t) =>
        t(e, n)
    ...
    CE = (e, t) =>
      !!Jo(t) ||
      (!!$o(t) && !yE(e.getBlockElements(), t) && !Lu(t) && !As(e, t)),
    wE = (e, t) => {
      if (Jo(t)) {
        if (0 === t.data.length) return !0;
        if (/^\s+$/.test(t.data) && (!t.nextSibling || yE(e, t.nextSibling)))
          return !0;
      }
      return !1;
    },
    ...
    kE = (e) => {
      ...
      if (
        ...
        ((e, t, n) => $(hp(yn(n), yn(t)), (t) => yE(e, t.dom)))(r, a, s)
      )
        return;
      const m = n.getRng(),
        {
      ...
      for (; v; )
        if (($o(v) && Ss(o, v), CE(o, v))) {
          ...
          i || ((i = xE(e)), a.insertBefore(i, v), (d = !0)),
            (l = v),
            (v = v.nextSibling),
            i.appendChild(l);
    ...
    RE = (e, t) => {
      ...
      if (n)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void NE(e, n))
          : void (qr(n) && (NE(e, n), e.undoManager.add()));
    },
    AE = ir,
    OE = (e, t, n) => {
    ...
    TE = (e, t) =>
      ((e, t) => {
        const n = t ? Jc.Forwards : Jc.Backwards,
          o = e.selection.getRng();
        return ((e, t, n) => Bk(t, e, n, gp, pp, AE))(n, e, o).orThunk(
          () => (OE(e, n, o), I.none())
        );
      })(
        e,
    ...
    GE = (e, t, n) =>
      te(Mn(e), (e) => (xn(e, t) ? (n(e) ? [e] : []) : GE(e, t, n))),
    YE = (e, t) => to(e, "table", t),
    XE = (e, t, n, o, r = M) => {
      const s = 1 === o;
    ...
    tS = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === tk.Wrap && 0 === e.positions.length)(o) ||
        (!rr(n.getNode()) &&
          ((e) => e.breakType === tk.Br && 1 === e.positions.length)(o))
      ...
      if (t && oS(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => ik(mk(e, Li.after(t)), n.left))
            )
    ...
    bS = (e, t, n) => {
      ...
      {
        const o = ai(pS);
        return I.from(o.backwards(e, t, hS(e), n)).map((e) =>
          gS(e.container, e.container.data.length)
        );
      }
    },
    vS = (e, t, n) => {
    ...
    yS = (e, t, n) => {
      ...
      {
        const r = ai(pS);
        return I.from(r.forwards(e, t, hS(e), n)).bind((e) =>
          yS(e.container, t - o.length, n)
        );
      }
    },
    CS = (e, t, n, o, r) => {
          ...
          ((e, t, n, o = 0) => {
            ...
            return CS(
              ...
              if (
                ...
                return I.none();
              const s = wS(r);
              return 0 !== s.lastIndexOf(n) || kS(s, n).length < o
                ? I.none()
                : I.some({ text: kS(s, n), range: r, trigger: n });
            });
          })(e, t, n, o),
        (t) => {
          const o = e.createRng();
  ...
  const AS = (e, t, n) => (e.stype === RS.Error ? t(e.serror) : n(e.svalue)),
    ...
    S_ = VS([
      ...
      r_("trigger"),
      d_("minChars", 1),
      (1, ((e, t) => t_(e, e, FS(1), YS()))("columns")),
      d_("maxResults", 10),
      ("matches", a_("matches", e_)),
      g_,
      p_,
      ((__ = JS), l_("highlightOn", [], WS(__))),
    ]);
  var __;
  const N_ = [x_, y_, v_, b_, h_],
    ...
    A_ = [
      m_("predicate", L),
      c_("scope", "node", ["node", "editor"]),
      c_("position", "selection", ["node", "selection", "line"]),
    ],
  ...
  VS(
    [
      ...
      m_("initValue", N("")),
      C_,
      ((e, t) => t_(e, e, { tag: "required", process: {} }, WS(t)))(
        "commands",
        P_
      ),
      a_(
        "launch",
        GS("type", { contextformbutton: B_, contextformtogglebutton: D_ })
      ),
    ].concat(A_)
  );
  const L_ = (e) => {
      const t = e.ui.registry.getAll().popups,
        n = pe(t, (e) => {
          return ((t = e),
          KS("Autocompleter", S_, { trigger: t.ch, ...t })).fold((e) => {
            throw new Error(
              "Errors: \n" +
                ((e) => {
                  const t =
      ...
      if ("character" === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            gu(!t, s, n).exists((e) => j_(o, e) && !Lt(i, z_(o, e)))
          ) ||
          gu(t, s, n).fold(L, (n) => {
            const r = z_(o, n);
            if (j_(o, n) && !Lt(i, r)) {
        ...
        if (p)
          ...
          const t = ((e) => {
            ...
            return (
              t.setStart(
                e.startContainer,
                fN(!0, e.startContainer, e.startOffset)
              ),
    ...
    NN = (e, t) => (n, o) => {
      const r =
        ((e) => nN(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    RN = (e) => {
    ...
    MN = (e, t, n) => {
      t.selection.isCollapsed() ||
        ...
        (C(n) && Y_(t, e.fakeEventName).isDefaultPrevented()) ||
          (e.insert(t, n), C(n) && G_(t, e.fakeEventName));
    },
    IN = (e, t) => {
      const n = () => MN(xN, e, t),
        o = () => MN(gN, e, t),
    ...
    qN = (e, t, n) => {
      n && !e.get()
        ? t.on("NodeChange", HN, !0)
        : !n && e.get() && t.off("NodeChange", HN),
        e.set(n);
    },
    VN = (e, t) => {
      const n = t.container(),
    ...
    QN = (e) =>
      ac(e)
        ...
        : [],
    JN = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), M_(e), MC(e)))
        return Da(null);
      {
        const t = Hk(e);
        return (
                ...
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    HE(
                          ...
                          ? [
                              {
                                ...
                                altKey: !0,
                                action: zE(W_, e, !1, a(!0)),
                              },
                              {
                                keyCode: ef.DELETE,
                                altKey: !0,
                                action: zE(W_, e, !0, a(!0)),
                              },
                              {
                                keyCode: ef.BACKSPACE,
                                metaKey: !0,
                                action: zE(W_, e, !1, a(!1)),
                              },
                            ]
                          : [
                              {
                      ...
                      .each((t) => {
                        n.preventDefault(),
                          Y_(e, o).isDefaultPrevented() || (t(), G_(e, o));
                      });
                  })(e, t, o);
            }),
              e.on("keyup", (t) => {
              ...
              t.isDefaultPrevented() ||
                ((e, t) => {
                  HE(
                    ...
                    t.preventDefault(),
                      Y_(e, "insertText", { data: " " }).isDefaultPrevented() ||
                        (n(), G_(e, "insertText", { data: " " }));
                  });
                })(e, t);
            });
          })(e),
  ...
  const iR = ti("mode"),
    ...
    LR = (e, t, n) =>
      !!((e, t) =>
        DR(t) && $(sc(e), (e) => $e(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
    ...
    FR = (e, t, n, o, r) => {
      ...
      if (!s.cancelled) {
        ...
        r
          ? Y_(e, "insertFromPaste", {
              dataTransfer: IR(t),
            }).isDefaultPrevented() || (n(), G_(e, "insertFromPaste"))
          : n();
      }
    },
    UR = (e, t, n, o) => {
      ...
      if (Ud(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              q(r, (e) => Pv(e).then((t) => ({ file: e, uri: t })))
            )).then((t) => {
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              n.html && UR(e, n.html, n.internal, !1),
                n.text && zR(e, n.text, !1);
            });
        })(e, n),
        ((e) => {
          const t = (t) => (n) => {
            ...
            ((e, t) => {
              Fd(e) &&
                ...
                e.on("dragover dragend", (n) => {
                  Ud(e) && !t.get() && (n.preventDefault(), JR(e, QR(e, n))),
    ...
    dA = (e) => {
      const t = ((e, t) => {
        const n = Li.fromRangeStart(e).getNode(),
          o = ((e, t) =>
            Jn(yn(e), (e) => ((e) => ar(e.dom))(e) || xr(e), aA(t)).getOr(yn(t))
              .dom)(n, t),
          r = lA(n, o, !1),
          s = lA(n, o, !0),
  ...
  const uA = (e, t) => Math.abs(e.left - t),
    ...
    hA = (e, t, n) =>
      ((e, t, n) => {
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: uA(e, t) < mA(e, t) ? cA.Before : cA.After,
          }))(e, t)
        ),
    bA = (e) => {
      var t, n;
    ...
    yA = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...vA(n) }))(
            e,
            o,
            t,
            r
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? bA(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
      ...
      const t = za(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            ...
            if (
              C(o) &&
              ((e, t, n) => CA(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o
              )
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = LA(e, n);
              PA(o)
                ? (t.preventDefault(), ux(e, o).each(f))
                : l(n) && ux(e, n).each(f);
            },
            !0
          ),
          e.on("mousedown", (r) => {
              ...
              !((e, t, n) => {
                const o = yn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return {
                      x: n - (e ? r.left + t.dom.clientLeft + pw(t) : 0),
                      y: o - (e ? r.top + t.dom.clientTop + gw(t) : 0),
                    };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = mw(e),
            ...
            PA(a)
              ...
              : hA(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === cA.Before, !1)) &&
                      t.setRng(o),
              ...
              e.on("focusin", (t) => {
                ...
                if (cr(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    ux(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    KA = (e, t, n) => {
      ((e, t, n) => {
        ...
        {
          const t = ai(pS);
          return I.from(t.forwards(e, 0, hS(e), n)).map((e) =>
            gS(e.container, 0)
          );
        }
      })(t, 0, t).each((o) => {
    ...
    XA = (e, t, n) => {
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(GA(e, t + "-end"), a),
        start: l.insertBefore(GA(e, t + "-start"), i),
      };
    },
    QA = (e, t, n) => {
          ...
          });
        {
          ...
          return m.map((e) => {
            ...
            return {
              ...
              position: gS(e.startContainer, e.startOffset),
            };
          });
        }
      });
                ...
                .map((e) =>
                  Dt.trim(i).length === e.start.length
                    ...
                    : [
                        {
                          pattern: e,
                          range: UA(s, s.getRoot(), t, 0, t, 0, true),
                        },
                      ]
                )
                .getOr([]);
                  ...
                  ((e, t) => {
                    ...
                    V(t, (t) =>
                      ((e, t) => {
                        const n = e.dom,
                          o = t.pattern,
                          r = jA(n.getRoot(), t.range).getOrDie(
                ...
                e.execCommand("mceInsertNewLine"),
                  n.each((t) => {
                    ...
                    n.data.charAt(t.offset - 1) === gr &&
                      ...
                      HA(e.dom, n.parentNode, (t) => t === e.dom.getRoot()));
                  });
              }
            ),
            !0)
    ...
    pO = (e) => {
      !0 !== e.removed &&
        (((e) => {
          MC(e) || e.load({ initial: !0, format: "html" }),
    ...
    hO = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (lO.addClass(t, "mce-content-body"),
      ...
      (o.disabled = !0),
        ...
        !e.readonly &&
          e.hasEditableRoot() &&
          (e.inline &&
            "static" === lO.getStyle(o, "position", !0) &&
        ...
        MC(e) ||
          ...
          ((e) => {
            ((e) => {
              ...
              e.on("keyup", (e) => {
                aO(n, e, (e, t) => e === t.keyCode && !ef.modifierPressed(t)) &&
                  s();
              }),
                e.on("keypress", (n) => {
                  aO(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    Gw(e) &&
                    !(Yw(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (bs(yn(t), !1)) {
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          Md(e) ||
            ((t.body.spellcheck = !1), lO.setAttrib(n, "spellcheck", "false")),
          (e.quirks = iO(e)),
          ((e) => {
    ...
    xO = async (e) => {
      e.dispatch("ScriptsLoaded"),
        ...
        ((e) => {
          ...
          if (m(t)) {
            const n = vw.get(t);
            (e.theme = n(e, vw.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  vw.urls[t] || e.documentBaseUrl.replace(/\/$/, "")
                );
          } else e.theme = {};
        })(e),
        ((e) => {
          ...
          : ((e, t) => {
              ((e, t) => {
                ...
                t.editorContainer &&
                  ...
                  (e.hidden = vO.isHidden(t.editorContainer))),
    ...
    LO = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: DO(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = TO(["mobile"], IS(a, r)),
        l = Dt.extend(
          n,
      ...
      return ((e, t, n, o) => {
        const r = OO(n.forced_plugins),
          ...
          i = ((e, t, n, o) => (e && BO(t, "mobile") ? o : n))(
            e,
            t,
            s,
            a.plugins ? OO(a.plugins) : s
          ),
          l = ((e, t) => [...OO(e), ...OO(t)])(r, i);
    ...
    IO = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = Up(o, Li.fromRangeStart(t))
                ? n.replace(/^ /, "&nbsp;")
                : n.replace(/^&nbsp;/, " ")),
              zp(o, Li.fromRangeEnd(t))
                ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;")
                : n.replace(/&nbsp;(<br( \/)?>)?$/, " ")
            );
          })(o, n.getRng(), t)
    ...
    FO = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        iC(e, {
          ...
          const n = ((e, t, n) => IC(e).editor.insertContent(t, n))(
            e,
            t.content,
            o
          );
          ...
          ((e, t, n) =>
            vb(
              ...
              (t) =>
                ((t) =>
                  uo(t, e).orThunk(() =>
                    zO(t) ? xe(UO, e).bind((e) => tn(t, e)) : I.none()
                  ))(t),
              (e) => En(yn(t), e)
            ))(e, t, n.dom).or(
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = WO(e, t);
                  e.formatter.toggle("fontname", { value: KO(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: WO(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => VO(e, (t) => $O(e.getBody(), t.dom)).getOr(""))(e)
                ),
                e.editorCommands.addQueryValueHandler("FontSize", () =>
                  ((e) => VO(e, (t) => HO(e.getBody(), t.dom)).getOr(""))(e)
                ),
  ...
  class JO {
    ...
    queryCommandState(e) {
      if ((!QO(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
  ...
  const ZO = "data-mce-contenteditable",
    ...
    rT = (e) => {
      e.parser.addAttributeFilter("contenteditable", (t) => {
        oT(e) &&
          V(t, (e) => {
            e.attr(ZO, e.attr("contenteditable")),
  ...
  const mT = (e, t) => {
      ...
      const n = od(e);
      return n
        ? (e.eventRoot || (e.eventRoot = cT.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    fT = (e, t, n) => {
      ((e) => !e.hidden && !oT(e))(e)
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(mT(n, e), e, n.delegates[e]),
      ...
      xT(kT(e.toLowerCase(), "+"), (e) => {
        ((e) => e in ST)(e)
          ...
          : ((t.charCode = e.charCodeAt(0)),
            (t.keyCode = ET[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
  ...
  class BT {
        ...
        const n = {},
          ...
          r = (e, t, n) => {
            ...
            return vT(r)
              ? ((o[e] = r.value), !0)
              : (console.warn(
                  bT(`Invalid value passed for the ${e} option`, r)
                ),
                !1);
          },
          s = (e) => ke(n, e);
            ...
            const a = ((e) => m(e.processor))(s)
              ...
              i = ((e, t, n) => {
                if (!v(t)) {
                  ...
                  console.error(
                    bT(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, s.default, a);
          ...
          t("id", { processor: "string", default: e.id }),
            ...
            t("font_css", {
              processor: (e) => {
                const t = m(e) || k(e, m);
                return t
                  ? { value: p(e) ? e : q(e.split(","), Ve), valid: t }
                  : {
                      valid: !1,
      ...
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            Ms.forElement(e, { contentCssCors: Ed(t), referrerPolicy: ql(t) }))(
            o,
            e
          )),
          pd(e)
        ...
        s &&
          ...
          hd(e) &&
            !Qo(e.getElement()) &&
            (kO.insertAfter(kO.create("input", { type: "hidden", name: t }), t),
            (e.hasHiddenInput = !0)),
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (AT.show(e.getContainer()), AT.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (AT.hide(e.getContainer()),
            AT.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    resetContent(e) {
      void 0 === e
        ? GC(this, this.startContent, { format: "raw" })
        : GC(this, e),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || AT.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = AT.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
            ...
            ? (t ||
              ...
              ((e) => {
                ...
                t &&
                  ...
                  aw.unbind(t, "submit reset", e.formEventDelegate));
              })(e),
              ((e) => {
                const t = e;
  ...
  const FT = (e) => {
    ...
    UT = (e) => {
      if (e !== MT) {
        const t = Oa.DOM;
        e
          ? (t.bind(window, "resize", FT), t.bind(window, "scroll", FT))
          : (t.unbind(window, "resize", FT), t.unbind(window, "scroll", FT)),
          (MT = e);
      }
    },
    zT = (e) => {
      ...
      return (
        (IT = G(IT, (t) => e !== t)),
        HT.activeEditor === e &&
          (HT.activeEditor = IT.length > 0 ? IT[0] : null),
        HT.focusedEditor === e && (HT.focusedEditor = null),
        t.length !== IT.length
      );
    },
    ...
    HT = {
      ...
      setup() {
        ...
        var s;
        (e.baseURL = new qy(o).toAbsolute(t)),
          (e.documentBaseURL = o),
          (e.baseURI = new qy(e.baseURL)),
          (e.suffix = n),
        ...
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(n.id))
                ? null
                : (zT(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === IT.length &&
                    window.removeEventListener("beforeunload", LT),
                  n.remove(),
                  UT(IT.length > 0),
                  n)
            );
      ...
      _setBaseUrl(e) {
        (this.baseURL = new qy(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new qy(this.baseURL));
      },
    };
  HT.setup();
  const $T = (() => {
